...
def objective(trial):
    ...
    try:
        ...
        preprocess_size = trial.suggest_categorical('preprocess_size', [64])
        ...
        num_heads = [trial.suggest_int(f'num_heads_{i}', 20, 50, step=2) for i in range(2)]
        ...
        base_model = GATv2Model(
            ...
            activation_fns=[nn.PReLU for _ in range(len(dropout_rates))],
